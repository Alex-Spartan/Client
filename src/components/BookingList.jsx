...
const BookingList = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold">Welcome back, {profile?.firstName || user?.displayName || "User"}!</h1>
          <p className="text-muted-foreground">Manage your bookings and favorite hotels</p>
        </div>
            ...
            <CardContent>
              {bookingsLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-4">Start exploring and book your first trip!</p>
                  <Button asChild>
